...
$(document).ready(function () {
    ...
    var currentPath = window.location.pathname.replace('.html', '');
    /* eslint-disable */console.log(...oo_oo(`1433874806_265_4_265_44_4`,'Ubicación: ' + currentPath));
    if (allowedPaths.includes(currentPath)) {
